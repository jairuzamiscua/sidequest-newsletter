...
<body>
    <div class="container">
        ...
        {'<div class="capacity-warning">❌ This event is currently full ({event["registration_count"]}/{event["capacity"]} registered).<br><small style="color: #aaa; margin-top: 10px; display: block;">Contact us directly if you\'d like to be notified of cancellations.</small></div>' if is_full else ''}
        ...
        <form class="form-container" id="registrationForm">
            ...
            <button type="button" class="submit-btn" disabled style="opacity: 0.5; cursor: not-allowed;">❌ Event Full</button>' if is_full else '<button type="submit" class="submit-btn" id="submitBtn">🎮 Register for Event</button>'}
        </form>
